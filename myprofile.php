  ...
  <div class="loader-container">
    ...
    <div class="profile-left">
            ...
            <div class="profile-left-edit">
                ...
                <div class="div" style="height: 1rem;"></div>
                <a href="/SANJAY_UNCLE/connection/logout.php"  class="button-2"><?php echo $myprofile_edit[$_GET['lang']][1]; ?> <i class="fa-solid fa-right-from-bracket"></i></a>
...
<!-- This are My Other Details -->
        ...
        ?>
            ...
            <!-- 
            <div class="matrimonial-profile">
                <form action="">
                    <div class="input">
                        <label for="father_name">Father's Name</label>
                        <input type="text" name="father_name" id="" required placeholder="Ranjit Kumar Shah">

                        <label for="mother_name">Mother's Name</label>
                        <input type="text" name="mother_name" id="" required placeholder="Ranjit Kumar Shah">
                    </div>
